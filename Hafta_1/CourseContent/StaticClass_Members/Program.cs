...
namespace StaticClass_Members
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Employee employee = new Employee("Cem", "Arda", "IT");
            Console.WriteLine("Number of Workers is {0}", Employee.EmployeeNumber);
            Employee employeeTwo = new Employee("Deniz", "Dara", "IT");
            Employee employeeThree = new Employee("Ahmet", "Bohça", "IT");
            Console.WriteLine("Number of Workers is {0}", Employee.EmployeeNumber);
